...
import 'package:mastermanager/core/errors/custom.exception.dart';
...
class ProductCategoryLocalDataSourceImpl
  ...
  Future<void> addCreatedCategory(ProductCategoryModel category) async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to add pending created category', statusCode: 500);
    }
  }
  ...
  Future<void> addUpdatedCategory(ProductCategoryModel category) async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to add pending updated category', statusCode: 500);
    }
  }
  ...
  Future<void> addDeletedCategoryId(String id) async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to add pending deleted category', statusCode: 500);
    }
  }
  ...
  Future<void> applyCreate(ProductCategoryModel category) async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to apply local category creation', statusCode: 500);
    }
  }
  ...
  Future<void> applyUpdate(ProductCategoryModel category) async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to apply local category update', statusCode: 500);
    }
  }
  ...
  Future<void> applyDelete(String id) async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to apply local category deletion', statusCode: 500);
    }
  }
  ...
  Future<List<ProductCategoryModel>> getAllLocalCategories() async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to load local category list', statusCode: 500);
    }
  }
  ...
  Future<ProductCategoryModel> getLocalCategoryById(String id) async {
    try {
      ...
      if (raw == null) {
        throw const LocalException(
            message: 'Category not found in cache', statusCode: 500);
      }
      return ProductCategoryModel.fromMap(Map<String, dynamic>.from(raw));
    } catch (_) {
      throw const LocalException(
          message: 'Failed to load local category', statusCode: 500);
    }
  }
  ...
  Future<List<ProductCategoryModel>> getPendingCreations() async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to load created queue', statusCode: 500);
    }
  }
  ...
  Future<List<ProductCategoryModel>> getPendingUpdates() async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to load updated queue', statusCode: 500);
    }
  }
  ...
  Future<List<String>> getPendingDeletions() async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to load deleted queue', statusCode: 500);
    }
  }
  ...
  Future<void> clearSyncedCreations() async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to clear created queue', statusCode: 500);
    }
  }
  ...
  Future<void> clearSyncedUpdates() async {
    try {
      ...
      throw const LocalException(
          message: 'Failed to clear updated queue', statusCode: 500);
    }
  }
