...
import 'package:mastermanager/features/synchronisation/cubit/product_category_sync_manager_cubit/product.category.sync.trigger.state.dart';
import '../../product_category_synchronisation_manager/product.category.sync.manager.dart';
...
class ProductCategorySyncTriggerCubit
  ...
  void startSyncing() {
    ...
    _syncTimer = Timer.periodic(const Duration(seconds: 10), (_) {
      print("oooooUUUUUUUUUUUUUUUUUUUUUHHHHHHHHHHHHHHHHHHHHHHH");
      _triggerSync();
    });
